...
(() => {
  ...
  var put, createMultipartUpload2, createMultipartUploader, uploadPart2, completeMultipartUpload2, upload, uploadPresigned, EventTypes;
  var init_client = __esm({
    "node_modules/@vercel/blob/dist/client.js"() {
      ...
      uploadPresigned = createPutMethod({
        allowedOptions: ["contentType"],
        extraChecks(options) {
          if (options.handleUploadUrl === void 0) {
            throw new BlobError(
  ...
  var require_render_ai = __commonJS({
    "src/client/render-ai.ts"() {
      ...
      document.addEventListener("DOMContentLoaded", () => {
        ...
        async function createUploadIntent(file) {
